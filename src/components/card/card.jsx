            ...
            <div className="card-body">
                <div className="conteiner">
                    ...
                    <button className={`btn`}>
                        {like ? <img onClick={() => likeChangeFalse()} className='btn-image' src='https://cdn.pixabay.com/photo/2016/02/04/11/57/heart-1179054__480.png' alt='heart' /> : <BsHeart onClick={() => likeChangeTrue()} />}
                    </button>
                    <button className={`btn`} onClick={() => buyChangeTrue()} >
                        {buy ? 'Bought' : "Buy"}
                    </button>
                </div>
            </div>
