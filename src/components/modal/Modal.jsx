  ...
  return (
    <div className='modal'>
      ...
      <div className="messages">
        {state.modalData.comment.map(({ id, title }) => (
      ...
      <div className="input">
        <input type="text" id='message' placeholder='Message' onKeyDown={(e) => changeValue(e)} onChange={(e) => setMessage(e.target.value)} value={message} />
      </div>
    </div>
  )
}
